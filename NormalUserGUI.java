...
public class NormalUserGUI extends JFrame {
    ...
    public NormalUserGUI(studentsDAO st_dao, int user_id) {
        this.st_dao  = st_dao;
    ...
    private void buildUI() {
        ...
        title.setForeground(new Color(100, 220, 160));
        ...
        studentTable.getTableHeader().setBackground(new Color(40, 120, 90));
        studentTable.getTableHeader().setForeground(Color.WHITE);
        studentTable.getTableHeader().setFont(new Font("SansSerif", Font.BOLD, 13));
        studentTable.setSelectionBackground(new Color(50, 160, 110));
    ...
    private void showAddDialog() {
        ...
        save.addActionListener(e -> {
            ...
            } catch (NumberFormatException ex) { error("Age must be a number."); }
        });
    ...
    private void showSearchDialog() {
        ...
        searchBtn.addActionListener(e -> {
            String name = nameField.getText().trim();
            if (name.isEmpty()) { error("Enter a name."); return; }
            tableModel.setRowCount(0);
            try (Connection con = dbconnection.dbcn()) {
            ...
            } catch (Exception ex) { error("Search failed: " + ex.getMessage()); }
        });
